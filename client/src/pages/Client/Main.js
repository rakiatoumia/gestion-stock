...
function Main() {
  ...
  const currentClients = Client.slice(indexOfFirstProduit, indexOfLastProduit);
      ...
      <table className="table">
        <thead className="table__thead">
          <tr>
            ...
            <th className="table__th">CP</th>
            <th className="table__th">Ville</th>
          ...
          {currentClients
            ...
            .map((el) => (
              <tr className="table-row">
                ...
                <td data-column="StockMin" className="table-row__td">
                  <p className="table-row__status">{el.CodePostal}</p>
                </td>
                <td data-column="StockMin" className="table-row__td">
                  <p className="table-row__status">{el.Ville}</p>
                </td>
                <td data-column="Etat" className="table-row__td">
                  <p className="table-row__progress status">{el.PhoneNumber}</p>
                </td>
                <td data-column="Etat" className="table-row__td">
                  <p className="table-row__progress status">{el.email}</p>
                </td>
                <td className="table-row__td">
                  <img
                    alt="edit"
